                            ...
                            {[
                                {
                                    ...
                                    info: 'Krishna Kuti, Plot No 128, CIDCO Waluj Mahanagar 2, Waluj, Chh. Sambhaji Nagar, Maharashtra 431136',
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="font-bold text-slate-800 tracking-tight text-sm md:text-base leading-tight group-hover:text-blue-700 transition-colors">{item.info}</p>
                                    </div>
                                </a>
                            ))}
                        </div>
                    ...
                    >
                        ...
                        <div className="absolute bottom-4 md:bottom-10 left-4 md:left-10 right-4 md:right-10 z-10 bg-white/95 backdrop-blur-md p-4 md:p-6 rounded-2xl md:rounded-3xl shadow-2xl border border-white flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-[10px] md:text-xs text-slate-500 font-bold tracking-widest mt-1">Krishna Kuti, Plot No 128, CIDCO Waluj Mahanagar 2, Waluj, Chh. Sambhaji Nagar, Maharashtra 431136</p>
                            </div>
